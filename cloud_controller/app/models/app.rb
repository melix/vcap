...
class App < ActiveRecord::Base
  ...
  Runtimes = %w[ruby18 ruby19 java node node06 groovy groovy2 php erlangR14B02 python2]
  Frameworks = %w[sinatra rack rails3 java_web spring grails node php otp_rebar lift wsgi django standalone play groovy unknown]
